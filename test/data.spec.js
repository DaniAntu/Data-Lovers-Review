...
//  it('is a function', () => {
//    expect(typeof window.dataPokemon.order).toBe('function');
//  });

//  it('is a function', () => {
//    expect(typeof window.dataPokemon.filterPokeType).toBe('function');
//  });

//  it('is a function', () => { 
//   expect(typeof window.dataPokemon.searchFor).toBe('function');
//  });

//  it('is a function', () => { 
//   expect(typeof window.dataPokemon.probability).toBe('function');
//  });
